...
const createPatient = () => {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        axios({
            url: 'http://localhost:8080/api/v2/patient/create',
            method: "POST",
            data: patients,
        }).then((res) => {
            window.location.reload(false);
            alert("Patient created suscessfully");
        });
    };
    ...
    return (
        <>
            <div className="container">
                <h1 className="title">Crear pacientes</h1>
                <br/>
                <div>
                    <form
                        id="crate-patient"
                    ...
                    >
                        ...
                        <div className="grid">
                            ...
                            <input className="form-control" type="text" name="age" required/>
                        </div>
                        <div className="grid">
                    ...
                    <Link href="/">
                        <div className="grid">
                            <a type="button" className="btn-sm btn-primary button-field">
                                Home
                            </a>
                        </div>
                    </Link>
